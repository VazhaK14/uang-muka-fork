...
if($selisih >= 0){
    echo "<span style='color:green'>Rp ".number_format($selisih,0,',','.')."</span>";
}else{
    echo "<span style='color:red'>(Rp ".number_format(abs($selisih),0,',','.').")</span>";
}
?>
</td>
</tr>
